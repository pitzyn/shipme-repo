 ...
 <div class="container">
  ...
  <div class="ship-pageheader">
              <ol class="breadcrumb ship-breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php printf(__("Category jobs","shipme") ) ?></li>
              </ol>
              <h6 class="ship-pagetitle"><?php echo  sprintf(__("Posted jobs in %s","shipme"), $term_title ) ?></h6>
            </div>
            ...
            'terms'    =>  get_query_var( 'term' ),
                      ...
                      'meta_query' => array($price_q, $closed, $featured) ,'meta_key' => $meta_key, 'orderby'=>$orderby,'tax_query' => array($asd));
